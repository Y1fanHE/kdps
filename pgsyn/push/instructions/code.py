...
LastEditTime: 2022-02-18 16:30:53
'''
...
from pgsyn.push.types import PushInt
from pgsyn.push.instruction import (
    SimpleInstruction,
    StateToStateInstruction
)
from pgsyn.push.instructions.common import _revert, _wrap_tuple, _dup
from pgsyn.push.atoms import Atom, InstructionMeta, CodeBlock, Literal
from pgsyn.push.state import PushState
